...
#SBATCH -J Step-1-Log_TESTING_A100 #job name
...
zebra_train_path=${TRAIN_DATA_DIR}/logic__wwq_zebra_puzzle_new_reward_320_10.parquet
### Logic (test)
#ordering_puzzle_test_path=${TEST_DATA_DIR}/logic__ordering_puzzle_dataset_100.parquet
zebralogic_test_path=${TEST_DATA_DIR}/logic__wwq_zebra_puzzle_new_reward_280_10.parquet
