...
class AsyncMultiProcessRewardManager:
    ...
    def __call__(self, data: DataProto, return_dict: bool = False):
        ...
        for i in range(len(data)):
            ...
            #solutions.append(prompt_str + response_str)
        ...
        for i, (result, data_source, response_str, ground_truth, valid_response_length) in enumerate(
            ...
            try:
                ...
                #all_verification_prompts.append(result['verification_prompt'])
            except Exception as e:
                print(f"AT ERROR RESULT = {result}")
