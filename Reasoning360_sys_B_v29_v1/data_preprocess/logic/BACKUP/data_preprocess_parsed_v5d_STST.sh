...
python ./data_preprocess/logic/our_pre_process_zebrapuzzle_to_guru_parsed_v5d_STST.py --data_path '/export/home/asifali/HF_cache/ZebraLogic' --data_setting 'small_train_small_test' --output_dir '/export/home/asifali/HF_cache/ZebraPuzzle_to_guru_parsed_v5d_STST'
