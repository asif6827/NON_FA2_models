...
SOLUTION_PROMPT_1_SHOT_SYS_NO_EXAMPLE = """
...
def serialize_smollm3_messages(messages, enable_thinking=True, add_generation_prompt=True):
    """
...
def make_map_fn_1_shot(split, data_source):
    def process_fn_1_shot(example, idx):
        ...
        messages = [
            ...
            {
                "role": "user",
                "content": SOLUTION_PROMPT_1_SHOT_USER.format(
        ...
        smol_prompt = serialize_smollm3_messages(
            messages,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_source_train', default='our_zebra_puzzle_new_reward_smolLM3', help='Name of data source')
    parser.add_argument('--data_source_test', default='our_zebra_puzzle_new_reward_test_smolLM3', help='Name of data source')
