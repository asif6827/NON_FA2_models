...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_source_train', default='our_zebra_puzzle_new_reward_llama3_v2', help='Name of data source')
    parser.add_argument('--data_source_test', default='our_zebra_puzzle_new_reward_test_llama3_v2', help='Name of data source')
