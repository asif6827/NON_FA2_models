...
#SBATCH -J MLXL-B-v29-H200-EXAONE-2-4B #job name
...
BASE_MODEL=/export/home/asifali/HF_cache/EXAONE-Deep-2.4B
...
### Logic (train)
zebra_train_path=${TRAIN_DATA_DIR}/logic_our_zebra_puzzle_new_reward_EXAONE_300.parquet

### Logic (test)
zebralogic_test_path=${TEST_DATA_DIR}/logic_our_zebra_puzzle_new_reward_test_EXAONE_700.parquet
