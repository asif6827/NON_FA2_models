...
#SBATCH -J MLXL-B1-H200-Qwen3-4B #job name
#SBATCH -p gpu-H200 # queue used
#SBATCH --exclude=crirdchpxd001,crirdchpxd002,crirdchpxd003,crirdchpxd005
...
WANDB_PROJECT="Sys_B1_Qwen3_4B_MLXL_1_1shot_H200" # Your wandb project name
