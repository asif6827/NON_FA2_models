...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_source_train', default='our_ar_lsat_ordering_new_reward', help='Name of data source')
    parser.add_argument('--data_source_test', default='our_ar_lsat_ordering_new_reward_test', help='Name of data source')
