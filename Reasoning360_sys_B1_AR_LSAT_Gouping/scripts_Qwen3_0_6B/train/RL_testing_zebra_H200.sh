...
#SBATCH -J Step-1-Log_TESTING_H200 #job name
...
NUM_GPUS=1  # Set the number of GPUs to use on this node
gpu_memory_utilization=0.7
# --- Resuming & Logging ---
RESUME_CKPT_DIR_NAME=""  # Fill in the W&B experiment name to resume from, otherwise leave empty to start from scratch
WANDB_PROJECT="Reasoning360_1_5B_Zebra_test" # Your wandb project name
...
export DEBUG_CODE=1
export TEST_SCORE_METHOD='gt+z3+clue'
export TRAIN_SCORE_METHOD='gt+z3+clue' # gt+z3+clue
export Z3_CLUE_GATE=0.7



# =================== Data Mixture ===================
SHARED_DATA_PATH=/export/home/asifali/HF_cache/ZebraPuzzle_to_guru_10/small_train_med_test
VALID_GENERATION_PATH=/export/home/asifali/Reasoning360/evaluation_results/small_train_small_test_1
...
zebra_train_path=${TRAIN_DATA_DIR}/logic_our_zebra_puzzle_new_reward_320_10.parquet
### Logic (test)
#ordering_puzzle_test_path=${TEST_DATA_DIR}/logic__ordering_puzzle_dataset_100.parquet
zebralogic_test_path=${TEST_DATA_DIR}/logic_our_zebra_puzzle_new_reward_test_280_10.parquet
...
train_prompt_bsz=1  # on-policy model update batchsize: train_prompt_bsz * rollout.n
gen_prompt_bsz=$((train_prompt_bsz * 1))
n_resp_per_prompt=1
train_prompt_mini_bsz=1  # model grad update batchsize
