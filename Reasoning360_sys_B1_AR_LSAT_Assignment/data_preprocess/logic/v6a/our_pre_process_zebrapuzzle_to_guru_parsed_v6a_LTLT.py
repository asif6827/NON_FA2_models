...
if __name__ == '__main__':
    ...
    elif args.data_setting == 'large_train_large_test':
        args.data_file = os.path.join(args.data_path, 'Zebra_Puzzle_large_200.json')
        pass
    else:
    ...
    if args.data_setting == 'large_train_large_test':
