...
#SBATCH -J eval-guru-qwen #job name
#SBATCH -p gpu-A100 # queue used
#SBATCH --gres gpu:1 #number of gpus needed, default is 1
#SBATCH -c 32  #number of CPUs needed, default is 1
#SBATCH --mem 100GB #amount of memory needed, default
...
SHARED_DATA_PATH=/export/home/asifali/guru_data/
