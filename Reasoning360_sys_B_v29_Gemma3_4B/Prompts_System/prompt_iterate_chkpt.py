...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--remove_chkpt", type=int, default=0, help="whether to remove checkpoint directory")
...
def main() -> None:
    ...
    if args.remove_chkpt == 1:
        info("Removing checkpoint Directory")
        try:
        ...
        info("Checkpoint Directory NOT REMOVED")
