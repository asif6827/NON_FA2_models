...
def make_map_fn(split, data_source):
    def process_fn(example, idx):
        ...
        user_prompt = SOLUTION_PROMPT_SYSTEM_SOLUTION_BASED + SOLUTION_PROMPT_USER_SOLUTION_BASED.format(puzzle=example['instruction'])
...
def make_map_fn_1_shot(split, data_source):
    def process_fn_1_shot(example, idx):
        ...
        user_prompt = SOLUTION_PROMPT_1_SHOT_SYS + SOLUTION_PROMPT_1_SHOT_USER.format(puzzle=example['instruction'])
...
if __name__ == '__main__':
    ...
    parser.add_argument('--shot', default='one', help='Directory to save processed data')
