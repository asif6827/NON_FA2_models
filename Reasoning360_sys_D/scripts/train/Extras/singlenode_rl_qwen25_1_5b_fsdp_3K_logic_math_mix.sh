...
#SBATCH -J train-RL-qwen25-1.5B_6K_logic_math_mix #job name
...
WANDB_PROJECT="Reasoning360_6K_logic_math_mix_Qwen2_5_1_5B" # Your wandb project name
...
train_files="['${math_train_path}','${arcagi1_train_path}','${arcagi2_train_path}', '${barc_train_path}', '${graph_train_path}', '${ordering_train_path}', '${zebra_train_path}' ]"  # Use math as example, add to more tasks as needed
test_files="['${math_test_path}','${aime_test_path}','${zebralogic_test_path}']"  # Use math as example, add to more tasks as needed
