...
export PYTHONPATH="/export/home/asifali/Reasoning360_parsed_Asif:${PYTHONPATH:-}"
...
WANDB_PROJECT="Sys_C_Asif_Qwen2_5_1_5B_STST_1_1shot_H200" # Your wandb project name
...
#BASE_MODEL=/export/home/asifali/HF_cache/Qwen3-1.7B
EXPERIMENT_SETUP='small_train_small_test_1_parsed_v2'

export REWARD_LOG_PATH=/export/home/asifali/Reasoning360_parsed_Asif/evaluation_results/$EXPERIMENT_SETUP/$MODEL_NAME
# =================== Data Mixture ===================
SHARED_DATA_PATH=/export/home/asifali/HF_cache/ZebraPuzzle_to_guru_parsed_v2/small_train_small_test
VALID_GENERATION_PATH=/export/home/asifali/Reasoning360_parsed_Asif/evaluation_results/$EXPERIMENT_SETUP/$MODEL_NAME
export PUZZLE_FEEDBACK_PATH=/export/home/asifali/Reasoning360_parsed_Asif/evaluation_results/$EXPERIMENT_SETUP/$MODEL_NAME
...
python -m recipe.dapo.main_dapo \
    ...
    +trainer.write_step_outputs=False \
    +trainer.step2_mini_batch_iteration=100 \
    +trainer.step2_batch_size=${train_step2_bsz} \
    +trainer.STEP1_SCORINING=True \
    +trainer.STEP2_SCORINING=True \
