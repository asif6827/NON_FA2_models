...
SYSTEM_NAME_LIST=("Reasoning360_sys_A_AR_LSAT_Ordering")
EVAL_PATH_LIST=("mlxl_train_mlxl_test_1_parsed_v6a_${ACRONYM}")
DATA_PATH_LIST=("AR_LSAT_ordering_A_v6a_${ACRONYM}/mlxl_train_mlxl_test")



SLURM_SCRIPT_A100="./scripts_Qwen3_8B/train/Parsed_v2/${ACRONYM}_1_1shot_A100_zebra_rl_fsdp_parsed_v2.sh"
