...
install_requires = [
    ...
    "transformers>=4.51.0",   # ✅ Qwen3-4B needs this
    "wandb",
    "packaging>=20.0",
...
# ✅ Pin flash-attn here (but DO NOT pin torch here)
GPU_REQUIRES = [
    "liger-kernel",
    "flash-attn==2.8.3",
    "nvitop",
...
# ✅ Replace old vLLM constraint that caused downgrades
VLLM_REQUIRES = [
    "vllm>=0.8.6,<0.15.0",
]
...
SGLANG_REQUIRES = [
    ...
    # ❌ REMOVE torch pin to avoid forcing torch==2.6.0 (breaks +cu124)
    # "torch==2.6.0",
]
