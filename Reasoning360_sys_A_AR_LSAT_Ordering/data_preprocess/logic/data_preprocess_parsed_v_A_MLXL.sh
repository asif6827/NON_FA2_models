...
python ./data_preprocess/logic/our_pre_process_zebrapuzzle_to_guru_parsed_v_A_MLXL.py --data_path '/export/home/asifali/HF_cache/ZebraLogic' --data_setting 'mlxl_train_mlxl_test' --output_dir '/export/home/asifali/HF_cache/ZebraPuzzle_to_guru_parsed_v_A_MLXL'
