...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_size', type=float, default=0.5, help='Proportion of data for train set')
    parser.add_argument('--test_size', type=float, default=0.5, help='Proportion of data for test set')
    ...
    elif args.data_setting == 'ml_train_ml_test':
        args.data_file = os.path.join(args.data_path, 'Zebra_Puzzle_ML_480.json')
    else:
    ...
    if args.data_setting == 'ml_train_ml_test':
