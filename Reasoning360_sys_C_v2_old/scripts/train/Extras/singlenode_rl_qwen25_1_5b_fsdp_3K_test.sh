...
#SBATCH -J train-RL-qwen25-1.5B_3K_test #job name
...
#SBATCH --mem 512GB #amount of memory needed, default
...
WANDB_PROJECT="Reasoning360_3K_1_5B_maths_test" # Your wandb project name
...
python -m recipe.dapo.main_dapo \
    ...
    trainer.log_val_generations=495 \
