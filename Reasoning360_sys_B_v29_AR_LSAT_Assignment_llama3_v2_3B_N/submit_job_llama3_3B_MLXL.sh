...
SYSTEM_NAME_LIST=("Reasoning360_sys_B_v29_AR_LSAT_Assignment_llama3_v2_3B_N")
EVAL_PATH_LIST=("mlxl_train_mlxl_test_1_parsed_v6a_${ACRONYM}")
DATA_PATH_LIST=("AR_LSAT_assignment_v6a_${ACRONYM}/mlxl_train_mlxl_test")



SLURM_SCRIPT_A100="./scripts_llama3_3B/train/Parsed_v2/${ACRONYM}_1_1shot_A100_zebra_rl_fsdp_parsed_v2.sh"
...
if false; then
    ...
    SLURM_SCRIPT_H200="./scripts_llama3_3B/train/Parsed_v2/${ACRONYM}_1_1shot_H200_zebra_rl_fsdp_parsed_v2.sh"
    for i in "${!TRAIN_TEMP_LIST[@]}"; do
        TRAIN_TEMP=${TRAIN_TEMP_LIST[$i]}
        TEST_TEMP=${TEST_TEMP_LIST[$i]}
        SCORING_METHOD=${SCORING_LIST[$i]}
