...
#SBATCH -J MTMT-C-v4-H200 #job name
#SBATCH -p gpu-H200 # queue used
#SBATCH --nodelist=crirdchpxd002,crirdchpxd004,crirdchpxd006
...
WANDB_PROJECT="Sys_B_v4_Qwen3_4B_MTMT_1_1shot_H200" # Your wandb project name
