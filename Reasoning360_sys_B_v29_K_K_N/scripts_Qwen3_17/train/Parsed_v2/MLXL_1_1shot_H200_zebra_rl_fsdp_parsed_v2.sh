...
#SBATCH -J MLXL-B-v29-H200-QWEN3-17B_K_K_N #job name
...
### Logic (train)
zebra_train_path=${TRAIN_DATA_DIR}/logic_our_k_k_new_reward_300.parquet

### Logic (test)
zebralogic_test_path=${TEST_DATA_DIR}/logic_our_k_k_new_reward_test_700.parquet
