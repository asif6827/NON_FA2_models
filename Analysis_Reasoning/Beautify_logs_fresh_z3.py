...
def normalize_value(value):
    """Normalize table values for robust equality checking."""
...
def extract_symbolic_steps(reasoning):
    """
    Extract only S_i reasoning statements from the interleaved NL reasoning.
    """
...
def model_to_table(context, model):
    """Convert a Z3 model into the same table structure as GT/prediction."""
