...
if false; then
    ...
    SCORING_LIST=("gt")
    EPOCH_LIST=(100)
    TEST_LIST=(12)   # Need to check as per conditions..!
    ACC_W_LIST=(0.8)
    Z3_W_LIST=(0.2)
    ...
    SLURM_SCRIPT_H200="./scripts/train/Parsed_v2/${ACRONYM}_1_1shot_H200_zebra_rl_fsdp_parsed_v2_003.sh"
...
SLURM_SCRIPT_H200="./scripts_Qwen3_4B/train/Parsed_v2/${ACRONYM}_1_1shot_H200_zebra_rl_fsdp_parsed_v2_003.sh"
for i in "${!TRAIN_TEMP_LIST[@]}"; do
    TRAIN_TEMP=${TRAIN_TEMP_LIST[$i]}
    TEST_TEMP=${TEST_TEMP_LIST[$i]}
    SCORING_METHOD=${SCORING_LIST[$i]}
