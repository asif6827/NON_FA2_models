...
#SBATCH -J Step-1-Log_TESTING_GPU_A100 #job name
...
export TRAIN_SCORE_METHOD='gt'
export Z3_CLUE_GATE=0.7

# =================== Data Mixture ===================
SHARED_DATA_PATH=/export/home/asifali/HF_cache/ZebraPuzzle_to_guru_10/small_train_med_test
VALID_GENERATION_PATH=/export/home/asifali/Reasoning360/evaluation_results/small_train_small_test_sample_10_1
