...
def main():
    ...
    parser.add_argument("--model_name_or_path", type=str, 
                      default="/root/autodl-tmp/model/Qwen2.5-0.5B-Instruct", 
                      help="Local model folder path or Hugging Face model ID")
    parser.add_argument("--data_path", type=str, 
                      default="./sft_datasets/jsonl/correct_only/train.jsonl", 
                      help="Cleaned training data path (json/jsonl, containing messages field)")
    parser.add_argument("--eval_data_path", type=str, 
                      default="./sft_datasets/jsonl/correct_only/test.jsonl", 
                      help="Validation data path")
    parser.add_argument("--save_dir", type=str, 
                      default="./test_checkpoints", 
                      help="Model save root directory")
    ...
    parser.add_argument("--wandb_project", type=str, default="Logic-Puzzle-SFT", 
                      help="WandB project name")
    parser.add_argument("--wandb_run_name", type=str, default="sft_logic_puzzle", 
