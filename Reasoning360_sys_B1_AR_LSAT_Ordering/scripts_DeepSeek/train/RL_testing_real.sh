...
#SBATCH -J Step-1-Log_REAL #job name
...
WANDB_PROJECT="Reasoning360_3K_logic_Qwen2_5_1_5B" # Your wandb project name
...
# =================== Data Mixture ===================
SHARED_DATA_PATH=/export/home/asifali/HF_cache/guru_data_20_all
...
zebra_train_path=${TRAIN_DATA_DIR}/logic__zebra_puzzle_1.3k_10.parquet
### Logic (test)
#ordering_puzzle_test_path=${TEST_DATA_DIR}/logic__ordering_puzzle_dataset_100.parquet
zebralogic_test_path=${TEST_DATA_DIR}/logic__zebra_puzzle_dataset_200_10.parquet
