...
#SBATCH -J ray-eval-guru-all-qwen1.5b-gpu_all_checkpoint_18K #job name
...
export PYTHONPATH="/export/home/asifali/Reasoning360_Eval:${PYTHONPATH:-}"
...
CKPTS_DIR=/export/home/asifali/Reasoning360/checkpoints/Reasoning360_18K_1_5B/single-node-20251111-120256-Qwen2.5-1.5B-Instruct
GLOBAL_STEP=${GLOBAL_STEP:-100}

# Data and output
SHARED_DATA_PATH=/export/home/asifali/HF_cache/guru_data
data_folder=${SHARED_DATA_PATH}/offline_eval
save_folder=/export/home/asifali/Reasoning360_Eval/evaluation_results/ray_gpu_all_guru_all_Qwen2_5_1_5B_checkpoint_18K
...
prefer_checkpoint=${prefer_checkpoint:-${PREFER_CHECKPOINT:-100}}
