...
#SBATCH -J Step-1-Log_TESTING #job name
...
WANDB_PROJECT="Reasoning360_1_5B_Guru_test" # Your wandb project name
...
# =================== Data Mixture ===================
SHARED_DATA_PATH=/export/home/asifali/HF_cache/guru_data_adjusted_10
...
zebra_train_path=${TRAIN_DATA_DIR}/logic_our_zebra_puzzle_new_reward_1.3k_10.parquet
### Logic (test)
#ordering_puzzle_test_path=${TEST_DATA_DIR}/logic__ordering_puzzle_dataset_100.parquet
zebralogic_test_path=${TEST_DATA_DIR}/logic_our_zebra_puzzle_new_reward_test_200_10.parquet
