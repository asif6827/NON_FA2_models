...
#SBATCH -J tr_H200_STMT_1_1shot #job name
...
WANDB_PROJECT="Zebra_logic_Qwen2_5_1_5B_STMT_1_1shot" # Your wandb project name
...
# =================== Data Mixture ===================
SHARED_DATA_PATH=/export/home/asifali/HF_cache/ZebraPuzzle_to_guru_1shot/small_train_med_test
VALID_GENERATION_PATH=/export/home/asifali/Reasoning360/evaluation_results/small_train_med_test_1_1shot/$MODEL_NAME
...
zebra_train_path=${TRAIN_DATA_DIR}/logic_our_zebra_puzzle_new_reward_320.parquet
### Logic (test)
#ordering_puzzle_test_path=${TEST_DATA_DIR}/logic__ordering_puzzle_dataset_100.parquet
zebralogic_test_path=${TEST_DATA_DIR}/logic_our_zebra_puzzle_new_reward_test_280.parquet
...
python -m recipe.dapo.main_dapo \
    ...
    trainer.log_val_generations=279 \
