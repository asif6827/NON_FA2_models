...
#SBATCH -J train-RL-qwen3-0_6B_3K_no_thinking #job name
...
export TMPDIR="/export/home/asifali/TMP"
export TEMP="$TMPDIR"
export TMP="$TMPDIR"
export RAY_TMPDIR="$TMPDIR"
export TORCHINDUCTOR_CACHE_DIR="$TMPDIR/torch_inductor"
export TRITON_CACHE_DIR="$TMPDIR/triton"
export TRITON_PTX_CACHE_DIR="$TMPDIR/ptx"
export PYTORCH_CUDA_ALLOC_CONF=garbage_collection_threshold:0.8

# SAFELY clean old Ray temp directories
...
${CONDA_BIN_PATH}ray start --head --num-gpus ${NUM_GPUS} --temp-dir="$RAY_TMPDIR"
sleep 5
