...
#SBATCH -J MLXL-B-v29-H200-Gemma3-1B #job name
...
BASE_MODEL=/export/home/asifali/HF_cache/gemma-3-1b-it
...
### Logic (train)
zebra_train_path=${TRAIN_DATA_DIR}/logic_our_zebra_puzzle_new_reward_gemma_300.parquet

### Logic (test)
zebralogic_test_path=${TEST_DATA_DIR}/logic_our_zebra_puzzle_new_reward_test_gemma_700.parquet
