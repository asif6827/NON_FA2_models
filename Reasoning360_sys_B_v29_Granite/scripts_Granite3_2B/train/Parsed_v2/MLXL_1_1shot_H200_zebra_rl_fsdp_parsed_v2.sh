...
#SBATCH -J MLXL-B-v29-H200-Granite3-2B #job name
...
BASE_MODEL=/export/home/asifali/HF_cache/granite-3.3-2b-instruct
...
### Logic (train)
zebra_train_path=${TRAIN_DATA_DIR}/logic_our_zebra_puzzle_new_reward_Granite3_300.parquet

### Logic (test)
zebralogic_test_path=${TEST_DATA_DIR}/logic_our_zebra_puzzle_new_reward_test_Granite3_700.parquet
