...
def compute_score(
    ...
    score_method = str(os.environ.get("TEST_SCORE_METHOD", "gt+z3"))
    # print(f"Score method in Model Training: {score_method}")
    try:
        parsed_reasoning, predicted_arrangement, parse_status = extract_reasoning_and_solution(solution_str=solution_str)
