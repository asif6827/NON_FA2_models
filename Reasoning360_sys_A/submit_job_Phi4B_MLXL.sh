...
SLURM_SCRIPT_A100="./scripts_Phi4B/train/Parsed_v2/${ACRONYM}_1_1shot_A100_zebra_rl_fsdp_parsed_v2.sh"
...
if false; then
    ...
    SLURM_SCRIPT_H200="./scripts_Phi4B/train/Parsed_v2/${ACRONYM}_1_1shot_H200_zebra_rl_fsdp_parsed_v2.sh"
    for i in "${!TRAIN_TEMP_LIST[@]}"; do
        TRAIN_TEMP=${TRAIN_TEMP_LIST[$i]}
        TEST_TEMP=${TEST_TEMP_LIST[$i]}
        SCORING_METHOD=${SCORING_LIST[$i]}
