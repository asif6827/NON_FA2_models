...
EVAL_PATH_LIST=("mlxl_train_mlxl_test_1_parsed_v_A_${ACRONYM}")
DATA_PATH_LIST=("ZebraPuzzle_to_guru_parsed_v_A_${ACRONYM}/mlxl_train_mlxl_test")



SLURM_SCRIPT_H200="./scripts_Qwen25_3B/train/Parsed_v2/${ACRONYM}_1_1shot_H200_zebra_rl_fsdp_parsed_v2.sh"
