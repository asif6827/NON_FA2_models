...
#SBATCH -J MLXL-B-v29-H200-QWEN3-17B-Assignment #job name
#SBATCH -p gpu-H200 # queue used
#SBATCH --exclude=crirdchpxd001,crirdchpxd003
...
WANDB_PROJECT="Sys_B_v29_Qwen3_17B_MLXL_1_1shot_H200" # Your wandb project name
...
### Logic (train)
zebra_train_path=${TRAIN_DATA_DIR}/logic_our_ar_lsat_assignment_new_reward_300.parquet

### Logic (test)
zebralogic_test_path=${TEST_DATA_DIR}/logic_our_ar_lsat_assignment_new_reward_test_69.parquet
