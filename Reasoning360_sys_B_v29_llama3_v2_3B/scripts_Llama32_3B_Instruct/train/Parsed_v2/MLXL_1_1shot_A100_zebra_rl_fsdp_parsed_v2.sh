...
#SBATCH -J MLXL-B-v29-A100-Llama3-3B #job name
...
#SBATCH -c 100  #number of CPUs needed, default is 1
...
WANDB_PROJECT="Sys_B_v29_Llama32_3B_MLXL_1_1shot_A100" # Your wandb project name
...
### Logic (train)
zebra_train_path=${TRAIN_DATA_DIR}/logic_our_zebra_puzzle_new_reward_llama3_v2_300.parquet

### Logic (test)
zebralogic_test_path=${TEST_DATA_DIR}/logic_our_zebra_puzzle_new_reward_test_llama3_v2_700.parquet
