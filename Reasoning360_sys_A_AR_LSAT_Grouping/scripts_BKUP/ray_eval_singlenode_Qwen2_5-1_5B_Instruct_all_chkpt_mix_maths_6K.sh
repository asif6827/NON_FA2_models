...
#SBATCH -J ray-eval-guru-all-qwen1.5b-gpu_all_chkpt_maths_on_mix_6K #job name
...
NUM_GPUS=4
n_nodes=${n_nodes:-1}
n_gpus_per_node=${n_gpus_per_node:-4}   # GPUs per node (set to 1 for single GPU)model Eval 50 epoches
...
CKPTS_DIR=/export/home/asifali/Reasoning360/checkpoints/Reasoning360_6K_logic_math_mix_Qwen2_5_1_5B/single-node-20251125-130536-Qwen2.5-1.5B-Instruct
GLOBAL_STEP=${GLOBAL_STEP:-70}

# Data and output
SHARED_DATA_PATH=/export/home/asifali/HF_cache/guru_data
data_folder=${SHARED_DATA_PATH}/offline_eval
save_folder=/export/home/asifali/Reasoning360/evaluation_results/ray_gpu_all_guru_all_Qwen2_5_1_5B_chkpt_maths_on_mix_3K


# rollout：0=HF  1=vLLM
use_vllm=${use_vllm:-${USE_VLLM:-1}}

# Whether to merge checkpoints
prefer_checkpoint=${prefer_checkpoint:-${PREFER_CHECKPOINT:-0}}
