...
#SBATCH -J tr_H200_guru_adjusted #job name
...
WANDB_PROJECT="Logic_Qwen2_5_1_5B_Guru_Adj" # Your wandb project name
...
export TRAIN_SCORE_METHOD='gt+z3' # gt+z3+clue
export Z3_CLUE_GATE=0.7

# =================== Data Mixture ===================
SHARED_DATA_PATH=/export/home/asifali/HF_cache/guru_data_adjusted
VALID_GENERATION_PATH=/export/home/asifali/Reasoning360/evaluation_results/guru_test_4
...
zebra_train_path=${TRAIN_DATA_DIR}/logic_our_zebra_puzzle_new_reward_1.3k.parquet
### Logic (test)
#ordering_puzzle_test_path=${TEST_DATA_DIR}/logic__ordering_puzzle_dataset_100.parquet
zebralogic_test_path=${TEST_DATA_DIR}/logic_our_zebra_puzzle_new_reward_test_200.parquet
...
python -m recipe.dapo.main_dapo \
    ...
    trainer.log_val_generations=199 \
