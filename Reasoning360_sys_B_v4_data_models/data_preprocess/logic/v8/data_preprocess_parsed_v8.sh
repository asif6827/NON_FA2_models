...
python ./data_preprocess/logic/v8/zebrapuzzle_to_guru_parsed_MLXL_v8.py --data_path '/export/home/asifali/HF_cache/ZebraLogic' --data_setting 'mlxl_nss_mlxl_nss' --output_dir '/export/home/asifali/HF_cache/ZebraPuzzle_to_guru_parsed_v8_MLXL'
