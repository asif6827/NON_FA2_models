...
#SBATCH -J MLXL-B-v29-H200-Phi4-3-8B_v2 #job name
...
### Logic (train)
zebra_train_path=${TRAIN_DATA_DIR}/logic_our_zebra_puzzle_new_reward_phi4_v2_300.parquet

### Logic (test)
zebralogic_test_path=${TEST_DATA_DIR}/logic_our_zebra_puzzle_new_reward_test_phi4_v2_700.parquet
