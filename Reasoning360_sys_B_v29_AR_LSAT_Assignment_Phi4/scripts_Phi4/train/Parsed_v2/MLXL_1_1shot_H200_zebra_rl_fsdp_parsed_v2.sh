...
#SBATCH -J MLXL-B-v29-H200-Phi4-ARLSAT-Assignment #job name
...
WANDB_PROJECT="Sys_B_v29_Phi4_MLXL_1_1shot_H200" # Your wandb project name
...
### Logic (train)
zebra_train_path=${TRAIN_DATA_DIR}/logic_our_ar_lsat_assignment_new_reward_phi4_300.parquet

### Logic (test)
zebralogic_test_path=${TEST_DATA_DIR}/logic_our_ar_lsat_assignment_new_reward_test_phi4_69.parquet
