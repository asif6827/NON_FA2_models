...
#SBATCH -J ray-eval-guru-20-qwen1.5b-gpu_all_checkpoint #job name
...
CKPTS_DIR=/export/home/asifali/Reasoning360/checkpoints/Reasoning360_3K/single-node-20251109-010843-Qwen2.5-1.5B-Instruct
...
save_folder=/export/home/asifali/Reasoning360_Eval/evaluation_results/ray_gpu_all_guru_20_Qwen2_5_1_5B_checkpoint
...
prefer_checkpoint=${prefer_checkpoint:-${PREFER_CHECKPOINT:-50}}
...
leaderboard_list=(
  "math"
  # "aime" "humaneval" "mbpp" "livecodebench"
