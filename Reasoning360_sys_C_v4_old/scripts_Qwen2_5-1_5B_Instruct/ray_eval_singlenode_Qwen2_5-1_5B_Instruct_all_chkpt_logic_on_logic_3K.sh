...
#SBATCH -J ray-eval-guru-all-qwen1.5b-gpu_all_chkpt_logic_on_logic_3K_top_1 #job name
...
CKPTS_DIR=/export/home/asifali/Reasoning360/checkpoints/Reasoning360_3K_logic_Qwen2_5_1_5B/single-node-20251125-002428-Qwen2.5-1.5B-Instruct
GLOBAL_STEP=${GLOBAL_STEP:-90}

# Data and output
SHARED_DATA_PATH=/export/home/asifali/HF_cache/guru_data
data_folder=${SHARED_DATA_PATH}/offline_eval
save_folder=/export/home/asifali/Reasoning360/evaluation_results/ray_gpu_all_guru_all_Qwen2_5_1_5B_chkpt_logic_on_logic_3K
...
for leaderboard in "${leaderboard_list[@]}"; do
  ...
  for data_file in "${matched_files[@]}"; do
    ...
    echo "Model being used is : ${MODEL_TO_USE}"
    echo "N-samples is : ${n_samples}"
    echo "Sampling is set to False"
    {
