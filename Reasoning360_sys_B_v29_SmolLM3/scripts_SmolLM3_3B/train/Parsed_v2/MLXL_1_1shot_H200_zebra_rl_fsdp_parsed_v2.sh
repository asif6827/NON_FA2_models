...
#SBATCH -J MLXL-B-v29-H200-SmolLM3-3B #job name
...
BASE_MODEL=/export/home/asifali/HF_cache/SmolLM3-3B
...
### Logic (train)
zebra_train_path=${TRAIN_DATA_DIR}/logic_our_zebra_puzzle_new_reward_smolLM3_300.parquet

### Logic (test)
zebralogic_test_path=${TEST_DATA_DIR}/logic_our_zebra_puzzle_new_reward_test_smolLM3_700.parquet
