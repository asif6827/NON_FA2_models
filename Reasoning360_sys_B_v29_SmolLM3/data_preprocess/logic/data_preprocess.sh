...
python ./data_preprocess/logic/our_pre_process_zebrapuzzle_to_guru.py --data_path '/export/home/asifali/HF_cache/ZebraLogic' --data_setting 'small_train_med_test' --shot 'one' --output_dir '/export/home/asifali/HF_cache/ZebraPuzzle_to_guru_1shot'

python ./data_preprocess/logic/our_pre_process_guru_readjust.py --input_path '/export/home/asifali/HF_cache/guru_data' --shot 'one' --output_dir '/export/home/asifali/HF_cache/guru_data_adjusted_1shot'
