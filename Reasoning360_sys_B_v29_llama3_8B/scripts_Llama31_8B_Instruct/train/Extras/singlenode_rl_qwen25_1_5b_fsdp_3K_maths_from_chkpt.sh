...
#SBATCH -J train-RL-qwen25-1.5B_3K_from_50_chkpoint #job name
...
# --- Resuming & Logging ---
RESUME_CKPT_DIR_NAME="single-node-20251122-165616-Qwen2.5-1.5B-Instruct"  # Fill in the W&B experiment name to resume from, otherwise leave empty to start from scratch
WANDB_PROJECT="Reasoning360_3K_1_5B" # Your wandb project name
