...
#SBATCH -J MLXL-B-v29-H200-Llama3-1-8B #job name
...
WANDB_PROJECT="Sys_B_v29_Llama32_3B_MLXL_1_1shot_H200" # Your wandb project name
...
### Logic (train)
zebra_train_path=${TRAIN_DATA_DIR}/logic_our_zebra_puzzle_new_reward_llama3_300.parquet

### Logic (test)
zebralogic_test_path=${TEST_DATA_DIR}/logic_our_zebra_puzzle_new_reward_test_llama3_700.parquet
