    ...
    try:
        ...
        if has_required_inputs:
            ...
            if sat_ok == 0.0:
                ...
                reward = 0.2 * parsing_reward + 0.6 * float(puzzle_acc_score) + 0.4 * (n_novel_steps / normalizer) + 0.2 * format_reward + 0.3 * consistency_score - 0.1 * (n_contradictions / normalizer)
