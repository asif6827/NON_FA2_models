...
python ./data_preprocess/logic/our_pre_process_zebrapuzzle_to_guru_parsed.py --data_path '/export/home/asifali/HF_cache/ZebraLogic' --data_setting 'small_train_small_test' --output_dir '/export/home/asifali/HF_cache/ZebraPuzzle_to_guru_parsed'

python ./data_preprocess/logic/our_pre_process_guru_readjust_parsed.py --input_path '/export/home/asifali/HF_cache/guru_data' --output_dir '/export/home/asifali/HF_cache/guru_data_adjusted_parsed'
