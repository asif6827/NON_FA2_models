...
import re
from verl.utils.reward_score.z3_reasoning_validator_demo_v10_deploy import validate_reasoning_steps
...
def compute_score(
    ...
    z3_out = {"steps": [],
              ...
              "base_unsat_debug": {"fatal_error"}
              }
    if n_houses and attribute_values and parsed_clues and parsed_reasoning:
        try:
            z3_out = validate_reasoning_steps(n_houses=n_houses, attribute_values=attribute_values, parsed_clues=parsed_clues,
                                              parsed_reasoning=parsed_reasoning, timeout_s=5.0, conflict_tolerant_clues=False, )
        except Exception as e:
            z3_out = {"steps": [],
                      "n_steps_total": 0,
                      "n_steps_parsed_ok": 0,
                      ...
                      "clue_skipped_underconstrained": [],
                      "clue_skipped_conflict": [],
                      "base_unsat_debug": {"fatal_error": f"{type(e).__name__}: {e}"}}
    ...
    try:
        ...
        reward, metrics = compute_rl_reward_from_z3(
            z3_out=z3_out,
        ...
        final_result["step_pass_rate"] = metrics["pass_rate_total"]
        ...
        final_result["step_pass_rate"] = 0.0
...
def main():
    ...
    for idx, line in enumerate(json_data):
        ...
        print("N-Steps-total", valid_out["n_steps_total"])
