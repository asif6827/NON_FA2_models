...
def serialize_gemma3_user_prompt(user_content: str) -> str:
    return (
...
def make_map_fn_1_shot(split, data_source):
    def process_fn_1_shot(example, idx):
        ...
        gemma_prompt = serialize_gemma3_user_prompt(user_prompt)

        data = {
            "data_source": data_source,
            "prompt": gemma_prompt,
            "raw_prompt": gemma_prompt,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_source_train', default='our_zebra_puzzle_new_reward_gemma', help='Name of data source')
    parser.add_argument('--data_source_test', default='our_zebra_puzzle_new_reward_test_gemma', help='Name of data source')
