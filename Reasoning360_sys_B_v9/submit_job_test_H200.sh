...
if false; then
    ...
    SCORING_LIST=("gt")
    EPOCH_LIST=(1000)
    TEST_LIST=(5)   # Need to check this for STST
    ACC_W_LIST=(0.8)
    Z3_W_LIST=(0.2)
...
Z3_W_LIST=(0.2)
SWITCH_EPOCH_LIST=(80)
SYSTEM_NAME_LIST=("Reasoning360_sys_B_v9")
...
SLURM_SCRIPT_H200="./scripts_Qwen3_4B/train/Parsed_v2/${ACRONYM}_1_1shot_H200_zebra_rl_fsdp_parsed_v_test.sh"
for i in "${!TRAIN_TEMP_LIST[@]}"; do
    TRAIN_TEMP=${TRAIN_TEMP_LIST[$i]}
    TEST_TEMP=${TEST_TEMP_LIST[$i]}
    SCORING_METHOD=${SCORING_LIST[$i]}
